...
tab1,tab2,tab3,tab4,tab5 = st.tabs(["Grafos no dirigidos","Grafos dirigidos"," Camino hamiltoneano","Camino euleriano","Grafos aciclico"])
...
#propuesta de ejemplo vida real
